          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <?php
                      ...
                      $categories->getAllCategoriesForNestedPageDropdown();
                    ?>
                </ul>
              </li>
            </ul>
            ...
            <ul class="d-flex">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <li><a class="dropdown-item" href="signin.php"><i class="fa-solid fa-right-to-bracket"></i> <span class="p-2">Login</span></a></li>
                      <li><a class="dropdown-item" href="signup.php"> <i class="fa-solid fa-user-plus"></i><span class="p-2">Register</span></a></li>
                    </ul>
                  </li>
            </ul>
          </div>
        ...
        <div class="row mb-lg-4 mb-md-4 mb-sm-4 ">
            <?php
                if(isset($_GET['category'])){
                  ...
                  $products->seeMoreonIndex($_GET['category']);
                }
           ?>
        </div>
